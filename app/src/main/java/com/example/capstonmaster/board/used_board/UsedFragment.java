...
public class UsedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        System.out.println("중고프래그먼트온크리에이트뷰");
        ...
        listView = root.findViewById(R.id.used_list);
        ...
        adapter = new UsedListViewAdapter(root.getContext(), list_itemArrayList);
